        ...
        if liked == "Yes":
            st.markdown(
                ...
                <div style="text-align: center; margin-top: 30px;">
                    <video width="100%" height="400" autoplay muted playsinline loop>
                        <source src="https://cdn.jsdelivr.net/gh/Satyam20112001/my-video-assets@main/RPReplay_Final1722203131-1.mp4">
